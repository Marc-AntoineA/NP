...
import { faTimes, faHome, faArrowsAlt, faCompress, faHiking, faInfo, faSignOutAlt, faEdit, faShareAlt, faDice, faRobot, faQuestion, faBroom, faUser, faLock } from '@fortawesome/free-solid-svg-icons'
...
library.add(faBroom); library.add(faUser); library.add(faLock);
